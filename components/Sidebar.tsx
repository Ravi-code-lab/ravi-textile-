...
import { 
  LayoutDashboard, Palette, Factory, Boxes, ShoppingCart, 
  ...
  const menu = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'DELIVERY_CHALLAN', label: 'Delivery', icon: Truck },
        { id: 'TAX_INVOICE', label: 'Invoices', icon: Receipt },
    ...
    },
    {
      ...
      icon: ShoppingBag,
      items: [
        { id: 'PURCHASE_ORDER', label: 'Purchase Orders', icon: FileText },
        { id: 'PURCHASE_INWARD', label: 'Inwards', icon: ArrowRightLeft },
    ...
    },
    {
      ...
      icon: Factory,
      items: [
        { id: 'DESIGN_RECIPE', label: 'Recipes / BOM', icon: FlaskConical },
        ...
        { id: 'JOB_WORK', label: 'Jobwork', icon: ArrowRightLeft },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'STOCK_AUDIT', label: 'Audit', icon: SearchCheck },
    ...
    },
    {
      ...
      icon: Wallet,
      items: [
        { id: 'ACCOUNTING', label: 'Ledger', icon: Wallet },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'OFFICES', label: 'Godowns', icon: Home },
      ].filter(item => isEnabled(item.id))
    }
  ];
