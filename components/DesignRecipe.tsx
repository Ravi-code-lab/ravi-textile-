  ...
  return (
    <div className="flex flex-col h-full bg-shopify-bg dark:bg-slate-950">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <div>
          <h1 className="text-3xl font-bold text-shopify-text dark:text-white">SKU Recipes / BOM</h1>
          <p className="text-base text-slate-500">Technical consumption and cost matrix for your designs.</p>
        </div>
      ...
      {/* Modal Section */}
      <BaseModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} title={editingId ? "Edit Recipe" : "Create Recipe"} size="xl">
