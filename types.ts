...
export interface Machine extends BaseEntity { name: string; model?: string; type: string; status: string; purchaseDate: string; lastServiceDate?: string; nextServiceDate: string; }
